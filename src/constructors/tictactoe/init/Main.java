package constructors.tictactoe.init;

import constructors.tictactoe.game.Game;
import constructors.tictactoe.game.internal.TicTacToeGame;
...
public class Main {
    ...
    private static Constructor<?> getFirstConstructor(Class<?> clazz) {
        ...
        if (constructors.length == 0)
            throw new IllegalStateException(String.format("No constructor found for class: %s", clazz.getName()));
